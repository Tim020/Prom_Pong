...
class Audio:
    ...
    # delay of 0.2 = quaver (nom nom)
    def __play_intro_music(self):
        GPIO.output(4, True)
        GPIO.output(18, True)
        print "playing A crotchet"
        self.__play_tone(1 / 440.00, 0.5, 0.5, 0.4)  # Play A crotchet
        print "playing A# crotchet"
        self.__play_tone(1 / 466.16, 0.5, 0.5, 0.2)  # Play A# quaver
        print "playing B crotchet"
        self.__play_tone(1 / 493.88, 0.5, 0.5, 0.4)  # Play B crotchet
        print "playing A quaver"
        self.__play_tone(1 / 440.00, 0.5, 0.5, 0.2)  # Play A quaver
        print "Rest quaver"
        # self.__play_tone(0, 0.5, 0.5, 0.2)  # Rest quaver
        time.sleep(0.04)
        print "playing C# quaver"
